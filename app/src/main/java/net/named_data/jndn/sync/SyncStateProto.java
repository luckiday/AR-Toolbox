...
public final class SyncStateProto {
  ...
  public interface SyncStateOrBuilder extends
      // @@protoc_insertion_point(interface_extends:net.named_data.net.named_data.jndn.sync.SyncState)
    ...
    /**
     * <code>required .net.named_data.net.named_data.jndn.sync.SyncState.ActionType type = 2;</code>
     */
    boolean hasType();
    /**
     * <code>required .net.named_data.net.named_data.jndn.sync.SyncState.ActionType type = 2;</code>
    ...
    /**
     * <code>optional .net.named_data.net.named_data.jndn.sync.SyncState.SeqNo seqno = 3;</code>
     */
    boolean hasSeqno();
    /**
     * <code>optional .net.named_data.net.named_data.jndn.sync.SyncState.SeqNo seqno = 3;</code>
  ...
  /**
   * Protobuf type {@code net.named_data.net.named_data.jndn.sync.SyncState}
   */
  public static final class SyncState extends
      com.google.protobuf.GeneratedMessage implements
      // @@protoc_insertion_point(message_implements:net.named_data.net.named_data.jndn.sync.SyncState)
      SyncStateOrBuilder {
    ...
    /**
     * Protobuf enum {@code net.named_data.net.named_data.jndn.sync.SyncState.ActionType}
     */
    public enum ActionType
      ...
      // @@protoc_insertion_point(enum_scope:net.named_data.net.named_data.jndn.sync.SyncState.ActionType)
    }

    public interface SeqNoOrBuilder extends
        // @@protoc_insertion_point(interface_extends:net.named_data.net.named_data.jndn.sync.SyncState.SeqNo)
        com.google.protobuf.MessageOrBuilder {
    ...
    /**
     * Protobuf type {@code net.named_data.net.named_data.jndn.sync.SyncState.SeqNo}
     */
    public static final class SeqNo extends
        com.google.protobuf.GeneratedMessage implements
        // @@protoc_insertion_point(message_implements:net.named_data.net.named_data.jndn.sync.SyncState.SeqNo)
        SeqNoOrBuilder {
      ...
      public static final class Builder extends
          ...
          // @@protoc_insertion_point(builder_implements:net.named_data.net.named_data.jndn.sync.SyncState.SeqNo)
        ...
        // Construct using net.named_data.net.named_data.jndn.sync.SyncStateProto.SyncState.SeqNo.newBuilder()
        private Builder() {
        ...
        // @@protoc_insertion_point(builder_scope:net.named_data.net.named_data.jndn.sync.SyncState.SeqNo)
      }
      ...
      // @@protoc_insertion_point(class_scope:net.named_data.net.named_data.jndn.sync.SyncState.SeqNo)
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:net.named_data.net.named_data.jndn.sync.SyncState)
      ...
      // Construct using net.named_data.net.named_data.jndn.sync.SyncStateProto.SyncState.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  bitField0_ |= 0x00000008;
      ...
      // @@protoc_insertion_point(builder_scope:net.named_data.net.named_data.jndn.sync.SyncState)
    }
    ...
    // @@protoc_insertion_point(class_scope:net.named_data.net.named_data.jndn.sync.SyncState)
  }

  public interface SyncStateMsgOrBuilder extends
      // @@protoc_insertion_point(interface_extends:net.named_data.net.named_data.jndn.sync.SyncStateMsg)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>repeated .net.named_data.net.named_data.jndn.sync.SyncState ss = 1;</code>
     */
  ...
  /**
   * Protobuf type {@code net.named_data.net.named_data.jndn.sync.SyncStateMsg}
   */
  public static final class SyncStateMsg extends
      com.google.protobuf.GeneratedMessage implements
      // @@protoc_insertion_point(message_implements:net.named_data.net.named_data.jndn.sync.SyncStateMsg)
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:net.named_data.net.named_data.jndn.sync.SyncStateMsg)
      ...
      // Construct using net.named_data.net.named_data.jndn.sync.SyncStateProto.SyncStateMsg.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Builder addAllSs(
          Iterable<? extends net.named_data.jndn.sync.SyncStateProto.SyncState> values) {
        if (ssBuilder_ == null) {
          ensureSsIsMutable();
      ...
      // @@protoc_insertion_point(builder_scope:net.named_data.net.named_data.jndn.sync.SyncStateMsg)
    }
    ...
    // @@protoc_insertion_point(class_scope:net.named_data.net.named_data.jndn.sync.SyncStateMsg)
  }
  ...
  static {
    String[] descriptorData = {
      ...
      ".net.named_data.jndn.sync\"\203\002\n\tSyncState\022\014\n\004name\030\001 \002(\t\022<" +
      "\n\004type\030\002 \002(\0162..net.named_data.net.named_data.jndn.sync." +
      "SyncState.ActionType\0228\n\005seqno\030\003 \001(\0132).ne" +
      "t.named_data.net.named_data.jndn.sync.SyncState.SeqNo\022\030" +
    ...
    internal_static_net_named_data_jndn_sync_SyncState_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_net_named_data_jndn_sync_SyncState_descriptor,
        new String[] { "Name", "Type", "Seqno", "ApplicationInfo", });
    internal_static_net_named_data_jndn_sync_SyncState_SeqNo_descriptor =
