...
public class TrustAnchorContainer {
   ...
   * @throws Error If groupId is a dynamic anchor group .
   */
  public final void
   ...
   * @throws Error a group with groupId already exists
   */
  public final void
  insert
   ...
   * @throws Error if the groupId does not exist.
   */
  public final TrustAnchorGroup
  getGroup(String groupId) throws Error
  {
    TrustAnchorGroup group = groups_.get(groupId);
    if (group == null)
      throw new Error
