...
public class TpmPrivateKey {
   ...
   * @throws Error for errors decoding the key.
   */
  public final void
  loadPkcs1(ByteBuffer encoding, KeyType keyType) throws Error
  {
    if (keyType == null) {
   ...
   */
  public final void
  loadPkcs1(ByteBuffer encoding) throws Error
  {
   ...
   */
  public final void
  loadPkcs8(ByteBuffer encoding, KeyType keyType) throws Error
  {
    if (keyType == null) {
   ...
   */
  public final void
  loadPkcs8(ByteBuffer encoding) throws Error
  {
   ...
   * @throws Error for errors decoding or decrypting the key.
   */
  public final void
   ...
   * @throws Error if no private key is loaded, or error
   * converting to a public key.
   */
  public final Blob
  derivePublicKey() throws Error
  {
   ...
   * @throws Error if the private key is not loaded, if
   ...
   */
  public final Blob
  decrypt(ByteBuffer cipherText) throws Error
  {
   ...
   * initialized.
   * @throws Error for unrecognized digestAlgorithm or an error
   * in signing.
   */
  public final Blob
   ...
   * @throws Error if no private key is loaded, or error encoding.
   */
  public final Blob
  toPkcs1() throws Error
  {
    if (keyType_ == null)
   ...
   */
  public final Blob
  toEncryptedPkcs8(ByteBuffer password) throws Error
  {
    if (keyType_ == null)
      throw new Error
   ...
   * @throws Error for an invalid key size, or an error generating.
   */
