...
public abstract class TpmBackEnd {
  ...
  hasKey(Name keyName) throws Error { return doHasKey(keyName); }
  ...
  getKeyHandle(Name keyName) throws Error
  {
   ...
   */
  public final void
  deleteKey(Name keyName) throws Error { doDeleteKey(keyName); }
   ...
   * @throws Error if the key does not exist or if the key cannot be
   * exported, e.g., insufficient privileges.
   */
  public final Blob
  exportKey(Name keyName, ByteBuffer password) throws Error
  {
    if (!hasKey(keyName))
   ...
   * @throws Error if a key with name keyName already exists, or for
   ...
   */
  public boolean
  isTerminalMode() throws Error { return true; }
   ...
   */
  public void
  setTerminalMode(boolean isTerminal) throws Error {}
   ...
   */
  public boolean
  isTpmLocked() throws Error { return false; }
   ...
   */
  public boolean
  unlockTpm(ByteBuffer password) throws Error { return !isTpmLocked(); }
  ...
  doHasKey(Name keyName) throws Error;
  ...
  doGetKeyHandle(Name keyName) throws Error;
   ...
   */
  protected abstract TpmKeyHandle
  doCreateKey(Name identityName, KeyParams params) throws Error;
  ...
  doDeleteKey(Name keyName) throws Error;
   ...
   */
  protected Blob
  doExportKey(Name keyName, ByteBuffer password) throws Error
  {
   ...
   * it to decrypt the PKCS #8 EncryptedPrivateKeyInfo. If the password is null,
   * import an unencrypted PKCS #8 PrivateKeyInfo.
   * @throws Error for an error importing the key.
   */
  protected void
  doImportKey
    (Name keyName, ByteBuffer pkcs8, ByteBuffer password) throws Error
  {
