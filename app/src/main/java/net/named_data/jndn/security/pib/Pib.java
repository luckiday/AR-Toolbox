...
public class Pib {
  ...
  /**
   * Get the TPM Locator.
   * @throws Error if the TPM locator is empty.
   */
  public final String
  getTpmLocator() throws Error, PibImpl.Error
  {
  ...
  getIdentity(Name identityName) throws PibImpl.Error, Error
  {
   ...
   * @return The PibIdentity object.
   * @throws Error if there is no default identity.
   */
  public final PibIdentity
   ...
   */
  public final PibIdentity
  addIdentity_(Name identityName) throws PibImpl.Error, Error
  {
    // BOOST_ASSERT(identities_.isConsistent());
  ...
  // This is to force an import of net.named_data.net.named_data.jndn.util.
